...
public class MyPoint implements Distanceable {
    ...
    public BigDecimal distance(Distanceable anotherMeasurable) {        
	...
	public Distanceable addToCentroid(Distanceable newCentroid, int i) {

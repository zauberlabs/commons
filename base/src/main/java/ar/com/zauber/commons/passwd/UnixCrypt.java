 ...
 * 
 * NOTE: Ender, was there a license associated with this code ? Since I don't
 * see one, Im going to assume its ok to check this in.
 * 
...
public final class UnixCrypt {
    ...
    /** TODO document */
    private static int dEncrypt(final int ll, final int r, final int ss,
            final int e0, final int e1, final int []s) {
        int l = ll;
        int v = r ^ r >>> 16;
        int u = v & e0;
        v &= e1;
        u = u ^ u << 16 ^ r ^ s[ss];
        int t = v ^ v << 16 ^ r ^ s[ss + 1];
        t = t >>> 4 | t << 28;
    ...
    /** TODO document */
    private static int hpermOp(final int aa, final int n, final int m) {
        int a = aa;
    ...
    /** TODO document */
    private static void permOp(final int aa, final int bb, final int n, final int m,
            final int []results) {
        int a = aa;
        int b = bb;
    ...
    /** TODO document */
    public static String crypt(final String aSalt, final String aOriginal) {
        String salt = aSalt;
        String original = aOriginal;
    ...
    /** TODO document */
    private static int fourBytesToInt(final byte []b, final int anOffset) {
        int offset = anOffset;
    ...
    /** TODO document */
    public static boolean matches(final String encryptedPassword,

...
public class MethodInvocationExceptionHandlerContext {
     ...
     */
    public MethodInvocationExceptionHandlerContext(final ErrorLog errorLog) {
        this();
     ...
     */
    public final void setErrorLog(final ErrorLog errorLog) {
        this.errorLog = errorLog;
    }
     ...
     */
    public final boolean isLogGenerated() {
